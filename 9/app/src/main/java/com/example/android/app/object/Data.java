package com.example.android.app.object;
...
public class Data {
    ...
    public CauHoi taoCauHoi(int x) {
        Random r = new Random();
        ArrayList<CauHoi> arr = arrCauHoi.get(x - 1);
    ...
    public void taoCauHoi1() {
        ...
        a3.add(taoCauHoi("Đâu là một loại hình chợ tạm tự phát thường xuất hiện trong các khu dân cư?", "Cóc", "Ếch" + "&" + "Thằn lằn" + "&"+ "Nhái"));
        arrCauHoi.add(a3);

        ArrayList<CauHoi> a4 = new ArrayList<>();
        a4.add(taoCauHoi("Đâu là tên một loại chợ?", "Cóc", "Ếch" + "&" + "Thằn lằn" + "&"+ "Nhái"));
        arrCauHoi.add(a4);

        ArrayList<CauHoi> a5 = new ArrayList<>();
        a5.add(taoCauHoi("Đâu là tên một bãi biển ở Quảng Bình?", "Đá Nhảy", "Đá Bò" + "&" + "Đá Chạy" + "&"+ " Đá Lăn"));
        arrCauHoi.add(a5);

        ArrayList<CauHoi> a6 = new ArrayList<>();
        a6.add(taoCauHoi("Haiku là thể thơ truyền thống của nước nào?", "Nhật Bản", "Mông Cổ" + "&" + "Hàn Quốc" + "&"+ "Trung Quốc"));
        arrCauHoi.add(a6);
    }
