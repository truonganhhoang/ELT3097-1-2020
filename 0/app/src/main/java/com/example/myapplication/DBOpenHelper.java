...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_EVENT_TABLE = "create table" + DBStructure.EVENT_TABLE_NAME + "(ID INTERGER PRIMARY KEY AUTOINCREMENT, "
            +DBStructure.EVENT + "TEXT, " + DBStructure.TIME + "TEXT, " + DBStructure.DATE + "TEXT, "+ DBStructure.MONTH + "TEXT, "+ DBStructure.YEAR + "TEXT)";
    private static final String DROP_EVENT_TABLE = "DROP TABLE IF EXIST" +DBStructure.EVENT_TABLE_NAME;
